...
Python, R, SQL, Machine Learning, TensorFlow, PyTorch, Pandas, NumPy, Spark, Tableau, Statistics, Mathematics""",
            ...
            {
                "filename": "mike_johnson_resume.txt",
                "original_filename": "mike_johnson_resume.txt",
                "file_path": "uploads/mike_johnson_resume.txt",
                "file_size": 987,
...
EXPERIENCE
Senior Frontend Developer | WebSolutions LLC | 2020-2024
...
Frontend Developer | DesignStudio | 2018-2020
...
EDUCATION
Bachelor of Science in Computer Science
University of Texas, Austin | 2014-2018

SKILLS
JavaScript, TypeScript, React, Vue.js, Next.js, HTML, CSS, Sass, Webpack, Jest, Cypress, Git, Agile""",
                "owner_id": created_users[0].id
            }
        ]
        ...
        for resume_data in resumes_data:
            ...
            if not existing_resume:
                # Generate embeddings for the resume content
                embeddings = embedding_service.generate_embeddings(resume_data["content"])
        ...
        jobs_data = [
            ...
            },
            {
                ...
                "description": "We need a skilled frontend developer to build beautiful and responsive user interfaces using React and modern web technologies.",
                "requirements": ["React", "JavaScript", "TypeScript", "CSS", "3+ years experience", "UI/UX knowledge"],
        ...
        for job_data in jobs_data:
            ...
            if not existing_job:
                ...
                embeddings = embedding_service.generate_embeddings(job_text)
